      ...
      >
        {filtered.map((t) => (
          ...
          >
            ...
            >
              <span style={{ fontSize: 12, fontWeight: 600, color: 'var(--fg-strong, #f1f4f8)' }}>
                {t.name}
              </span>
              {t.isPublic && (
                <span
            ...
            <span style={{ fontSize: 11, color: 'var(--fg-muted, #7b8a9e)', lineHeight: 1.4 }}>
              {t.description}
            </span>
        ...
        {filtered.length === 0 && (
          <div style={{ fontSize: 12, color: 'var(--fg-muted, #7b8a9e)', gridColumn: '1/-1' }}>
            未找到模板。
          </div>
        )}
      </div>
