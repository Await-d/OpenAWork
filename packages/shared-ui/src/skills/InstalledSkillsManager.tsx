...
const muted: CSSProperties = { ...cell, color: 'var(--fg-muted, #7b8a9e)' };
  ...
  return (
    ...
    >
      ...
      >
        ...
        <button type="button" style={btn('var(--accent, #5cd4c0)')} onClick={onCheckUpdates}>
          检查更新
        </button>
      </div>
                  ...
                  <td style={cell}>
                    {(() => {
                      ...
                      const badgeStyle: CSSProperties = {
                        ...
                        color: skill.enabled ? color.success : 'var(--fg-muted, #7b8a9e)',
