...
const ACTION_META: Record<PermissionAction, { label: string; color: string; icon: string }> = {
  allow: { label: '允许', color: '#22c55e', icon: '✓' },
  deny: { label: '禁止', color: '#ef4444', icon: '✕' },
  ask: { label: '询问', color: '#f59e0b', icon: '?' },
};
        ...
        return (
          <button
            ...
            style={{
              ...
              color: isActive ? meta.color : 'var(--color-muted, #64748b)',
    ...
    >
      ...
      >
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ fontSize: 10, color: 'var(--color-muted, #94a3b8)', marginTop: 2 }}>
        ...
        {category.supportsPatterns && (
          <button
            ...
            style={{
              ...
              padding: '2px 6px',
              fontSize: 9,
              borderColor: expanded ? 'var(--color-accent, #6366f1)' : undefined,
              color: expanded ? 'var(--color-accent, #6366f1)' : undefined,
            }}
          >
            {expanded ? '收起' : '模式'}
          </button>
  ...
  return (
    <div style={{ ...CARD, ...style }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        {saving && (
          <span style={{ fontSize: 10, color: 'var(--color-muted, #94a3b8)' }}>保存中…</span>
        )}
      </div>
