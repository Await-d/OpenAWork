...
export function PermissionPrompt({
  ...
  return (
    <div
      ...
      style={{
        border: `1px solid ${riskLevel === 'high' ? 'rgba(248,113,113,0.45)' : 'var(--color-border, #334155)'}`,
        borderRadius: 12,
        padding: 14,
...
function btnStyle(
  ...
  const base: Record<typeof tone, { fg: string; bg: string; border: string }> = {
    primary: {
      fg: 'var(--color-surface, #0f172a)',
      bg: '#6366f1',
      border: '#4f46e5',
    },
    secondary: {
      fg: 'var(--color-text, #f1f5f9)',
      bg: 'rgba(99,102,241,0.14)',
      border: 'rgba(99,102,241,0.36)',
    },
    subtle: {
      fg: 'var(--color-muted, #94a3b8)',
      bg: 'transparent',
