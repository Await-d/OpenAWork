...
declare const Service_base: Context.ServiceClass<
  Service,
...
) => Effect.Effect<WebSocketConnection, LLMError, never>;
...
export declare const json: <Body, Message>(
