...
export declare const custom: (apply: (input: AuthInput) => Effect.Effect<Headers.Headers, LLMError>) => Auth;
...
export declare function bearerHeader(name: string, source: Secret | Credential): Auth;
export declare const toEffect: (input: Auth) => (authInput: AuthInput) => Effect.Effect<Headers.Headers, LLMError>;
