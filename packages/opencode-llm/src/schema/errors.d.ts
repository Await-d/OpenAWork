...
declare const HttpResponseDetails_base: Schema.Class<
  HttpResponseDetails,
  Schema.Struct<{
...
declare const HttpRateLimitDetails_base: Schema.Class<
...
declare const HttpContext_base: Schema.Class<
  HttpContext,
  Schema.Struct<{
...
declare const InvalidRequestReason_base: Schema.Class<
...
declare const NoRouteReason_base: Schema.Class<
  NoRouteReason,
  Schema.Struct<{
...
declare const AuthenticationReason_base: Schema.Class<
  AuthenticationReason,
  Schema.Struct<{
    readonly _tag: Schema.tag<'Authentication'>;
    readonly message: Schema.String;
    readonly kind: Schema.Literals<
      readonly ['missing', 'invalid', 'expired', 'insufficient-permissions', 'unknown']
    >;
    readonly providerMetadata: Schema.optional<
      Schema.$Record<Schema.String, Schema.$Record<Schema.String, Schema.Unknown>>
    >;
...
declare const RateLimitReason_base: Schema.Class<
  RateLimitReason,
  Schema.Struct<{
...
declare const QuotaExceededReason_base: Schema.Class<
  QuotaExceededReason,
  Schema.Struct<{
...
declare const ContentPolicyReason_base: Schema.Class<
  ContentPolicyReason,
  Schema.Struct<{
...
declare const ProviderInternalReason_base: Schema.Class<
...
declare const TransportReason_base: Schema.Class<
  TransportReason,
  Schema.Struct<{
...
declare const InvalidProviderOutputReason_base: Schema.Class<
...
declare const UnknownProviderReason_base: Schema.Class<
...
export declare const LLMErrorReason: Schema.toTaggedUnion<
  '_tag',
  readonly [
    typeof InvalidRequestReason,
    typeof NoRouteReason,
    typeof AuthenticationReason,
    typeof RateLimitReason,
    typeof QuotaExceededReason,
    typeof ContentPolicyReason,
    typeof ProviderInternalReason,
    typeof TransportReason,
    typeof InvalidProviderOutputReason,
    typeof UnknownProviderReason,
  ]
>;
export type LLMErrorReason = Schema.Schema.Type<typeof LLMErrorReason>;
declare const LLMError_base: Schema.Class<
  LLMError,
  Schema.TaggedStruct<
    'LLM.Error',
    {
      ...
      readonly method: Schema.String;
      readonly reason: Schema.toTaggedUnion<
        '_tag',
        readonly [
          typeof InvalidRequestReason,
          typeof NoRouteReason,
...
declare const ToolFailure_base: Schema.Class<
  ToolFailure,
  Schema.TaggedStruct<
    'LLM.ToolFailure',
    {
