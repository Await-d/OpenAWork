...
export declare const mergeJsonRecords: (
...
export declare const AnthropicProviderOptions: Schema.StructWithRest<
  Schema.Struct<{
    readonly contextManagement: Schema.optional<
      Schema.Struct<{
        readonly edits: Schema.$Array<
          Schema.Union<
            readonly [
...
export declare const ProviderOptions: Schema.StructWithRest<
  Schema.Struct<{
    readonly anthropic: Schema.optional<
...
export declare const mergeProviderOptions: (
  ...items: ReadonlyArray<ProviderOptions | undefined>
) => ProviderOptions | undefined;
declare const HttpOptions_base: Schema.Class<
  HttpOptions,
  Schema.Struct<{
...
export declare const mergeHttpOptions: (
  ...items: ReadonlyArray<HttpOptions | undefined>
) => HttpOptions | undefined;
declare const GenerationOptions_base: Schema.Class<
  GenerationOptions,
  Schema.Struct<{
...
export declare const mergeGenerationOptions: (
  ...items: ReadonlyArray<GenerationOptionsInput | undefined>
) => GenerationOptions | undefined;
declare const ModelLimits_base: Schema.Class<
  ModelLimits,
  Schema.Struct<{
...
declare const ModelCompatibility_base: Schema.Class<
  ModelCompatibility,
  Schema.Struct<{
...
declare const CacheHint_base: Schema.Class<
  CacheHint,
  Schema.Struct<{
...
export declare const CachePolicyObject: Schema.Struct<{
  ...
  readonly messages: Schema.optional<
    Schema.Union<
      readonly [
...
export declare const CachePolicy: Schema.Union<
  readonly [
    Schema.Literal<'auto'>,
    Schema.Literal<'none'>,
    Schema.Struct<{
