...
declare const ToolResultValueSchema: Schema.Union<
  readonly [
    Schema.Struct<{
...
export declare const ToolResultValue: Schema.Union<
  readonly [
    Schema.Struct<{
      readonly type: Schema.Literal<'json'>;
      readonly value: Schema.Unknown;
...
export declare const ContentPart: Schema.toTaggedUnion<
  'type',
  readonly [
    Schema.Struct<{
      readonly type: Schema.Literal<'text'>;
...
declare const Message_base: Schema.Class<
  Message,
  Schema.Struct<{
...
declare const ToolDefinition_base: Schema.Class<
  ToolDefinition,
  Schema.Struct<{
    readonly name: Schema.String;
...
declare const ToolChoice_base: Schema.Class<
  ToolChoice,
  Schema.Struct<{
...
export declare const ResponseFormat: Schema.toTaggedUnion<
  'type',
  readonly [
    Schema.Struct<{
      readonly type: Schema.Literal<'text'>;
...
declare const LLMRequest_base: Schema.Class<
  ...
  Schema.Struct<{
    ...
    readonly responseFormat: Schema.optional<
      Schema.toTaggedUnion<
        'type',
        readonly [
          Schema.Struct<{
      ...
      >
    >;
    readonly cache: Schema.optional<
      Schema.Union<
        readonly [
          Schema.Literal<'auto'>,
          Schema.Literal<'none'>,
