...
public sealed class GatewayWebApplicationFactory : WebApplicationFactory<OpenAWork.Gateway.Host.Program>
{
    public string DatabasePath { get; private set; } = string.Empty;

    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        DatabasePath = Path.Combine(Path.GetTempPath(), $"openawork-gateway-{Guid.NewGuid():N}.db");
