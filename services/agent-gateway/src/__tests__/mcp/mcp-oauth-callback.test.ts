...
vi.mock('../../mcp/mcp-oauth-provider.js', async () => {
  ...
  const actual = await vi.importActual<McpOAuthProviderModule>('../../mcp/mcp-oauth-provider.js');
  return {
    ...actual,
...
import { setOAuthEntry } from '../../mcp/mcp-oauth-store.js';
import type * as McpOAuthProviderActual from '../../mcp/mcp-oauth-provider.js';
