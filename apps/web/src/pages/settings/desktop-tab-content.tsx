...
const DANGER_BTN: React.CSSProperties = {
  ...
  borderColor: 'color-mix(in srgb, var(--danger, #dc2626) 40%, transparent)',
};
            ...
            style={{
              ...
              border:
                autostartMsg.type === 'success'
                  ...
                  : '1px solid color-mix(in srgb, var(--danger, #dc2626) 40%, transparent)',
              background:
                autostartMsg.type === 'success'
                  ? 'color-mix(in srgb, #16a34a 8%, transparent)'
                  : 'color-mix(in srgb, var(--danger, #dc2626) 8%, transparent)',
              color: autostartMsg.type === 'success' ? '#15803d' : 'var(--danger, #dc2626)',
            }}
          >
        ...
        {pinMode === 'idle' ? (
          ...
          >
            ...
            {pinError ? (
              <div
                role="alert"
                style={{ fontSize: 11, color: 'var(--danger, #dc2626)', lineHeight: 1.5 }}
              >
                {pinError}
              </div>
            ) : null}
