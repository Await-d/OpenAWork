...
const PAUSED_RIBBON_STYLE: CSSProperties = {
  ...
  gap: 10,
  padding: '6px 14px',
  background: 'color-mix(in srgb, var(--warning, var(--warning, #f0b429)) 14%, var(--surface))',
  borderBottom: '1px solid color-mix(in srgb, var(--warning, var(--warning, #f0b429)) 35%, transparent)',
  fontSize: 12,
          ...
          <div style={PAUSED_RIBBON_STYLE} role="alert">
            ...
            <button
              ...
              style={{
                padding: '3px 12px',
                borderRadius: 6,
                border: '1px solid color-mix(in srgb, var(--success, var(--success, var(--success, #3dd49a))) 50%, transparent)',
