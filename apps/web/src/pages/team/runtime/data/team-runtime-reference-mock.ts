    ...
    items: [
      {
        ...
        roleTagRows: [
          [
            { color: 'var(--warning, #f0b429)', label: '团队负责人' },
            { color: 'var(--chart-5, var(--chart-5, #c4b5fd))', label: '架构师' },
            { color: 'var(--aux, var(--aux, #8b9cf5))', label: '后端工程师' },
          ],
          [
            { color: 'var(--success, #3dd49a)', label: '前端工程师' },
            { color: 'var(--aux, #8b9cf5)', label: '测试工程师' },
          ],
        ],
      },
    ],
    ...
    items: [
      {
        ...
        roleTagRows: [
          [
            { color: 'var(--warning, #f0b429)', label: '团队负责人' },
            { color: 'var(--accent, var(--accent, #5cd4c0))', label: '研究员A' },
            { color: 'var(--complement, #f06b7e)', label: '研究员B' },
            { color: 'var(--danger, #f06b7e)', label: '批评者' },
          ],
        ],
      },
    ],
    ...
    items: [
      {
        ...
        roleTagRows: [
          [
            { color: 'var(--aux, var(--aux, #8b9cf5))', label: '体验架构与合规策划' },
            { color: 'var(--success, #3dd49a)', label: '小程序前端研发' },
          ],
          [
            { color: 'var(--warning, #f0b429)', label: '解析后端工程师' },
            { color: 'var(--complement, #f06b7e)', label: '项目与合规审查' },
          ],
        ],
      },
    ],
    ...
    items: [
      {
        ...
        roleTagRows: [
          [
            { color: 'var(--aux, var(--aux, #8b9cf5))', label: '体验策略负责人' },
            { color: 'var(--success, #3dd49a)', label: '小程序 UI/交互实现' },
          ],
          [
            { color: 'var(--warning, #f0b429)', label: '解析与内容编排' },
            { color: 'var(--complement, #f06b7e)', label: '项目与合规测试' },
          ],
          [{ color: 'var(--chart-5, var(--chart-5, #c4b5fd))', label: '交付协调与汇总' }],
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        roleTagRows: [
          [
            { color: 'var(--warning, #f0b429)', label: '团队负责人' },
            { color: 'var(--aux, var(--aux, #8b9cf5))', label: '产品策划' },
            { color: 'var(--success, #3dd49a)', label: '文案策划' },
          ],
          [
            { color: 'var(--complement, #f06b7e)', label: '视觉设计' },
            { color: 'var(--warning, var(--warning, #f0b429))', label: '前端开发' },
            { color: 'var(--danger, var(--danger, #f06b7e))', label: '质审审查' },
          ],
        ],
      },
    ],
...
export const agentTeamsConversationCards: AgentTeamsConversationCard[] = [
  ...
  },
  {
    ...
    meta: 'Codex CLI · 等待输入',
    role: '研究员A',
    roleAccent: 'var(--accent, var(--accent, #5cd4c0))',
    timestamp: '14:28',
    type: 'question',
  ...
  },
  {
    ...
    meta: 'Codex CLI · 已完成',
    role: '研究员B',
    roleAccent: 'var(--complement, #f06b7e)',
    timestamp: '14:15',
    type: 'result',
    ...
    cards: [
      {
        ...
        title: '补会议桌旁的墙面挂件',
        assignee: '研究员A',
        assigneeAccent: 'var(--accent, var(--accent, #5cd4c0))',
      ...
      },
      {
        ...
        title: '对齐模板卡的行间距',
        assignee: '研究员B',
        assigneeAccent: 'var(--complement, #f06b7e)',
      ...
      },
      {
        ...
        title: '添加新建团队模板弹窗',
        assignee: '团队负责人',
        assigneeAccent: 'var(--warning, #f0b429)',
      ...
      },
      {
        ...
        assignee: '批评者',
        assigneeAccent: 'var(--danger, #f06b7e)',
...
export const agentTeamsMessageCards: AgentTeamsMessageCard[] = [
  {
    id: 'message-1',
    from: '团队负责人',
    fromAccent: 'var(--warning, #f0b429)',
    to: '研究员A',
    toAccent: 'var(--accent, var(--accent, #5cd4c0))',
    route: 'unicast',
    type: 'update',
    timestamp: '14:32',
  ...
  },
  {
    ...
    fromAccent: 'var(--warning, #f0b429)',
    to: '全体成员',
    toAccent: 'var(--chart-5, var(--chart-5, #c4b5fd))',
    route: 'broadcast',
    type: 'update',
    timestamp: '14:30',
  ...
  },
  {
    id: 'message-3',
    from: '研究员B',
    fromAccent: 'var(--complement, #f06b7e)',
    to: '批评者',
    toAccent: 'var(--danger, #f06b7e)',
    route: 'unicast',
    type: 'question',
    timestamp: '14:25',
  ...
  },
  {
    id: 'message-4',
    from: '批评者',
    fromAccent: 'var(--danger, #f06b7e)',
    to: '团队负责人',
    toAccent: 'var(--warning, #f0b429)',
    route: 'unicast',
    type: 'result',
    timestamp: '14:18',
  ...
  },
  {
    id: 'message-5',
    from: '研究员A',
    fromAccent: 'var(--accent, var(--accent, #5cd4c0))',
    to: '团队负责人',
    toAccent: 'var(--warning, #f0b429)',
    route: 'unicast',
    type: 'question',
...
export const agentTeamsNewTemplateRoles = [
  { value: 'leader', label: '团队负责人', color: 'var(--warning, #f0b429)' },
  { value: 'researcher', label: '研究员', color: 'var(--accent, var(--accent, #5cd4c0))' },
  { value: 'critic', label: '批评者', color: 'var(--danger, #f06b7e)' },
  { value: 'architect', label: '架构师', color: 'var(--chart-5, var(--chart-5, #c4b5fd))' },
  { value: 'backend', label: '后端工程师', color: 'var(--aux, var(--aux, #8b9cf5))' },
  { value: 'frontend', label: '前端工程师', color: 'var(--success, #3dd49a)' },
  { value: 'tester', label: '测试工程师', color: 'var(--aux, #8b9cf5)' },
];
...
> = {
  session_start: { color: 'var(--success, var(--success, #3dd49a))', label: '启动', icon: 'play' },
  thinking: { color: 'var(--chart-5, #c4b5fd)', label: '思考', icon: 'thinking' },
  read: { color: 'var(--aux, var(--aux, #8b9cf5))', label: '读取', icon: 'file-read' },
  write: { color: 'var(--chart-5, var(--chart-5, #c4b5fd))', label: '写入', icon: 'file-write' },
  file_create: { color: 'var(--chart-5, var(--chart-5, #c4b5fd))', label: '创建', icon: 'file-create' },
  command_execute: { color: 'var(--warning, #f0b429)', label: '命令', icon: 'command' },
  tool_use: { color: 'var(--aux, var(--aux, #8b9cf5))', label: '工具', icon: 'tool' },
  error: { color: 'var(--danger, #f06b7e)', label: '错误', icon: 'error' },
  waiting_confirmation: { color: 'var(--warning, #f0b429)', label: '确认', icon: 'confirm' },
  user_input: { color: 'var(--success, var(--success, #3dd49a))', label: '输入', icon: 'input' },
  turn_complete: { color: 'var(--aux, var(--aux, #8b9cf5))', label: '回合完成', icon: 'turn-complete' },
  task_complete: { color: 'var(--success, var(--success, #3dd49a))', label: '完成', icon: 'task-complete' },
  assistant_message: { color: 'var(--aux, #8b9cf5)', label: '回复', icon: 'reply' },
};
...
export const agentTeamsTimelineEvents: AgentTeamsTimelineEvent[] = [
  {
    ...
    agentId: 'leader',
    agentName: '团队负责人',
    agentAccent: 'var(--warning, #f0b429)',
  },
  {
    id: 'evt-2',
    type: 'thinking',
    ...
    agentId: 'researcher-a',
    agentName: '研究员A',
    agentAccent: 'var(--accent, var(--accent, #5cd4c0))',
  },
  {
    id: 'evt-3',
    type: 'read',
  ...
  },
  {
    ...
    agentId: 'backend',
    agentName: '后端工程师',
    agentAccent: 'var(--aux, var(--aux, #8b9cf5))',
  },
  {
    id: 'evt-5',
  ...
  },
  {
    ...
    agentId: 'architect',
    agentName: '架构师',
    agentAccent: 'var(--chart-5, var(--chart-5, #c4b5fd))',
  },
  {
    id: 'evt-10',
    type: 'error',
