    ...
    items: [
      {
        ...
        roleTagRows: [
          [
            { color: 'var(--warning)', label: '团队负责人' },
            { color: 'var(--chart-5)', label: '架构师' },
            { color: 'var(--aux)', label: '后端工程师' },
          ],
          [
            { color: 'var(--success)', label: '前端工程师' },
            { color: 'var(--aux)', label: '测试工程师' },
          ],
        ],
      },
    ],
    ...
    items: [
      {
        ...
        roleTagRows: [
          [
            { color: 'var(--warning)', label: '团队负责人' },
            { color: 'var(--accent)', label: '研究员A' },
            { color: 'var(--complement)', label: '研究员B' },
            { color: 'var(--danger)', label: '批评者' },
          ],
        ],
      },
    ],
    ...
    items: [
      {
        ...
        roleTagRows: [
          [
            { color: 'var(--aux)', label: '体验架构与合规策划' },
            { color: 'var(--success)', label: '小程序前端研发' },
          ],
          [
            { color: 'var(--warning)', label: '解析后端工程师' },
            { color: 'var(--complement)', label: '项目与合规审查' },
          ],
        ],
      },
    ],
    ...
    items: [
      {
        ...
        roleTagRows: [
          [
            { color: 'var(--aux)', label: '体验策略负责人' },
            { color: 'var(--success)', label: '小程序 UI/交互实现' },
          ],
          [
            { color: 'var(--warning)', label: '解析与内容编排' },
            { color: 'var(--complement)', label: '项目与合规测试' },
          ],
          [{ color: 'var(--chart-5)', label: '交付协调与汇总' }],
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        roleTagRows: [
          [
            { color: 'var(--warning)', label: '团队负责人' },
            { color: 'var(--aux)', label: '产品策划' },
            { color: 'var(--success)', label: '文案策划' },
          ],
          [
            { color: 'var(--complement)', label: '视觉设计' },
            { color: 'var(--warning)', label: '前端开发' },
            { color: 'var(--danger)', label: '质审审查' },
          ],
        ],
      },
    ],
...
export const agentTeamsMessageCards: AgentTeamsMessageCard[] = [
  ...
  },
  {
    id: 'message-4',
    from: '批评者',
    fromAccent: 'var(--danger)',
    to: '团队负责人',
    toAccent: 'var(--warning)',
    route: 'unicast',
    type: 'result',
    timestamp: '14:18',
...
export const agentTeamsNewTemplateRoles = [
  { value: 'leader', label: '团队负责人', color: 'var(--warning)' },
  { value: 'researcher', label: '研究员', color: 'var(--accent)' },
  { value: 'critic', label: '批评者', color: 'var(--danger)' },
  { value: 'architect', label: '架构师', color: 'var(--chart-5)' },
  { value: 'backend', label: '后端工程师', color: 'var(--aux)' },
  { value: 'frontend', label: '前端工程师', color: 'var(--success)' },
  { value: 'tester', label: '测试工程师', color: 'var(--aux)' },
];
