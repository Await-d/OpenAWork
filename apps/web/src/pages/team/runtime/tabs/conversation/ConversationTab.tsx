...
import { CONV_TYPE_META } from '../../shared/team-runtime-shared.js';
import { Icon, ChevronDownIcon, SendIcon } from '../../shared/TeamIcons.js';
          ...
          {filteredCards.map((card) => {
            ...
            return (
              <div
                ...
                className="team-card-tinted-bordered"
                  ...
                  {isSelected && (
                    ...
                    >
                      <input
                        ...
                        placeholder="回复此对话…"
                        className="team-input-focusable-glow"
                        style={{
                          flex: 1,
                          padding: '7px 12px',
                          borderRadius: 7,
            ...
            >
              {roleChips.map((chip) => {
                ...
                return (
                  <div
                    key={chip.id}
                    className={isActive ? undefined : 'team-hover-surface-bordered-strong'}
