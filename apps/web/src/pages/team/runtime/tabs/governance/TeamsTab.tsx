...
import { ChevronDownIcon, PauseIcon, ResumeIcon, TrashIcon } from '../../shared/TeamIcons.js';
...
function TeamCard({
  ...
  return (
    <div
      className={isSelected ? undefined : 'team-card-soft'}
...
export function TeamsTab() {
  ...
  return (
    <TabContainer title="成员" subtitle="按运行 / 历史分组的团队会话清单，可暂停 / 恢复 / 删除。">
