...
import type { AgentTeamsSidebarTeam, AgentTeamsWorkspaceGroup } from './team-runtime-types.js';
                  ...
                  <Fragment key={`${group.workspacePath ?? group.workspaceLabel}-${bucket}`}>
                    ...
                    {sessions.map((session) => {
                      ...
                      return (
                        ...
                        >
                          {/* 左侧状态柱（顶部圆点 + 垂直时间柱，包含 running 脉冲） */}
                          <span
                            aria-hidden="true"
                            style={{
                              flexShrink: 0,
                              ...
                              style={{
                                ...
                                boxShadow:
                                  session.status === 'running'
                                    ...
                                    : `0 0 0 2px color-mix(in srgb, ${dot} 14%, transparent)`,
                              }}
                            >
                              {session.status === 'running' ? (
                                <span
                              ...
                              >
                                ...
                                <span
                                  style={{
                                    ...
                                    minWidth: 0,
                                    display: '-webkit-box',
                                    WebkitLineClamp: active || hovered ? 2 : 1,
      ...
      {contextMenu ? (
        ...
        >
          ...
          <button
            ...
            onMouseEnter={(event) => {
              (event.currentTarget as HTMLElement).style.background =
                'color-mix(in srgb, var(--danger, #d4574e) 10%, transparent)';
            }}
            onMouseLeave={(event) => {
              (event.currentTarget as HTMLElement).style.background = 'transparent';
            }}
