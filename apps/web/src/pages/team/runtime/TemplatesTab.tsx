...
import { ChevronDownIcon, PlusIcon, TemplateIcon, SyncIcon, TrashIcon } from './TeamIcons.js';
    ...
    <div style={{ display: 'grid', gap: 14, alignContent: 'start' }}>
      ...
      >
        <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
          <TemplateIcon size={16} color="var(--accent)" />
          <span style={{ fontSize: 15, fontWeight: 800, color: 'var(--text)' }}>模板管理</span>
          <span
            style={{
              minWidth: 20,
              height: 20,
