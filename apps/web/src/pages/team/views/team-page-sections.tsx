...
import QuestionPromptCard from '../../../components/common/display/QuestionPromptCard.js';
...
const panelStyle: React.CSSProperties = {
  ...
  background:
    'linear-gradient(180deg, color-mix(in srgb, var(--bg-overlay) 94%, rgba(91, 140, 255, 0.08)) 0%, var(--bg-overlay) 100%)',
          ...
          members.map((member) => (
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 2, minWidth: 0 }}>
                ...
                <span style={{ fontSize: 12, color: 'var(--fg-muted)' }}>{member.email}</span>
              </div>
              <div
              ...
              >
                ...
                <span style={{ fontSize: 11, color: 'var(--fg-muted)' }}>{member.status}</span>
              </div>
            </div>
          ))
        )}
          ...
          tasks.map((task) => {
            ...
            return (
              ...
              >
                ...
                {task.result ? (
                  <div style={{ fontSize: 12, lineHeight: 1.6, color: 'var(--fg-default)' }}>
                    {task.result}
                  </div>
                ) : null}
          ...
          messages.map((message) => {
            ...
            return (
              ...
              >
                ...
                <div style={{ fontSize: 13, lineHeight: 1.7, color: 'var(--fg-strong)' }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    borderColor: active
                      ...
                      : 'color-mix(in srgb, var(--border-default) 82%, transparent)',
                    background: active
            ...
            {sharedSessionLoading ? (
              ...
              <>
                <div style={{ display: 'grid', gap: 6 }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', gap: 12 }}>
                    <span style={{ fontSize: 18, fontWeight: 800, color: 'var(--fg-strong)' }}>
                  ...
                  {previewMessages.length === 0 ? (
                    ...
                    previewMessages.map((message) => (
                      ...
                      >
                        ...
                        <span style={{ fontSize: 12, lineHeight: 1.7, color: 'var(--fg-default)' }}>
