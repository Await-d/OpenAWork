  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', gap: 3, flexWrap: 'wrap' }}>
        ...
        {roleTags.length > 4 && (
          <span style={{ fontSize: 8, color: 'var(--fg-muted)' }}>+{roleTags.length - 4}</span>
        )}
      </div>
    </button>
  );
  ...
  const rightPanel = useMemo(() => {
    ...
    return (
      ...
      >
        ...
        <span style={{ fontSize: 12, color: 'var(--fg-muted)', maxWidth: 280, lineHeight: 1.6 }}>
    ...
    <div className="page-root" style={{ background: SHELL_BACKGROUND, minHeight: '100dvh' }}>
      ...
      >
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '280px 1fr', overflow: 'hidden' }}>
            ...
            <div style={{ overflow: 'auto', padding: '8px' }}>
              ...
              {!templateLoading && templateCount === 0 && !templateError && (
                ...
                >
                  ...
                  <span style={{ fontSize: 11, color: 'var(--fg-muted)' }}>暂无模板</span>
                </div>
              )}
          ...
          <div style={{ overflow: 'auto', background: 'var(--bg-base)' }}>{rightPanel}</div>
        </div>
      </div>
