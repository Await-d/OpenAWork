...
const OVERLAY_STYLE: React.CSSProperties = {
  position: 'fixed',
  inset: 0,
  background: 'color-mix(in srgb, var(--shadow-strong, #000) 50%, transparent)',
  zIndex: 100,
  display: 'flex',
  alignItems: 'center',
    ...
    >
      <div style={PANEL_STYLE}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
          ...
          <p style={{ margin: 0, color: 'var(--text-2)', fontSize: 12, lineHeight: 1.6 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
          <span style={{ fontSize: 11, color: 'var(--text-3)', fontWeight: 600 }}>当前路径</span>
          <div
            style={{
              padding: '6px 8px',
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
          ...
          {!willClear && !isAbsolute && draft.length > 0 && (
            <span style={{ fontSize: 11, color: 'var(--danger, #c33)' }}>路径必须以 / 开头</span>
          )}
        </div>
        ...
        {requiresForce && (
          <label
            style={{
              ...
              gap: 8,
              padding: '8px 10px',
              border: '1px solid var(--warn, #c93)',
              borderRadius: 6,
              background: 'color-mix(in srgb, var(--warn, #c93) 8%, transparent)',
              fontSize: 12,
              lineHeight: 1.6,
              color: 'var(--text)',
              cursor: 'pointer',
