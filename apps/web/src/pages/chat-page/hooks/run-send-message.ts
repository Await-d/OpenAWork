...
import { applyPermissionDecisionToLocalAssistantMessages, applyToolResultToLocalAssistantMessages, dismissPermissionEventMessage, hasActivePendingPermissionRequest, matchClientSlashCommand, matchServerSlashCommand, parseToolCallInputText, sanitizeComposerPlainText, upsertPermissionEventMessage } from '../../../components/conversation-runtime/messages/support.js';
...
import { hasGatewayAdvancedRound, resolveNextRoundIndex, shouldStartNewRound } from '../../../components/conversation-runtime/stream/stream-round-boundary.js';
...
import { appendStreamingTextDelta, appendStreamingThinkingDelta, markStreamingReasoningSegmentEnded, upsertStreamingToolSegment } from '../../../components/conversation-runtime/stream/streaming-segments.js';
import { appendStreamingThinkingChunk, buildStreamingThinkingChunkDeliveryKey, joinStreamingThinkingTexts, markStreamingThinkingChunkEnded } from '../../../components/conversation-runtime/stream/streaming-thinking.js';
...
import { applySessionChildRuntimeEvent, applyTaskUpdateRuntimeEvent } from '.././conversation/render/apply-session-runtime-event.js';
import { applyStreamToolProgress, applyStreamToolResult } from '.././conversation/render/apply-stream-tool-event.js';
...
export interface SendMessageDeps {
  ...
  readonly appendAssistantEventMessages: (events: RunEvent[], options?: { excludeCompaction?: boolean | undefined; } | undefined) => void;
  readonly appendCommandCard: (card: CommandResultCard) => void;
  readonly appendImageGenerationSummaryMessage: (input: { artifactTitle: string; messageSummary: string; modelId: string; providerId: string; revisedPrompt: string | null; sourcePrompt: string; }) => void;
  ...
  readonly generateImageForSession: (params: { inputArtifacts?: { artifactId: string; fileName?: string | undefined; mimeType?: string | undefined; }[] | undefined; prompt: string; sessionId: string; }) => Promise<SessionImageGenerationResponse>;
  ...
  readonly loadCurrentSessionSnapshot: (targetSessionId: string, options?: { expectedSessionViewEpoch?: number | undefined; messageLimit?: number | undefined; replaceMessages?: boolean | undefined; signal?: AbortSignal | undefined; since?: number | undefined; } | undefined) => Promise<void>;
  readonly loadPendingQuestionForSession: (targetSessionId: string, requestId: string) => Promise<void>;
  ...
  readonly scrollToBottom: (behavior?: ScrollBehavior | undefined, align?: "center" | "latest-edge" | undefined) => void;
  ...
  readonly setLatestGeneratedImageResult: Dispatch<SetStateAction<{ artifactId: string; artifactTitle: string; modelLabel: string; } | null>>;
  ...
  readonly setRightTab: (value: "mcp" | "overview" | "plan" | "tools" | "bookmarks" | "terminals" | "skills" | "snapshots" | "history" | "viz" | "agent" | ((prev: "mcp" | "overview" | "plan" | "tools" | "bookmarks" | "terminals" | "skills" | "snapshots" | "history" | "viz" | "agent") => "mcp" | "overview" | "plan" | "tools" | "bookmarks" | "terminals" | "skills" | "snapshots" | "history" | "viz" | "agent")) => void;
