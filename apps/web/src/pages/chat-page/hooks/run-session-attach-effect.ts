 ...
 */
import { resolveAttachEffectDisposition, shouldAttemptAttachToSession, shouldResetAttachAttempt } from '../../../components/conversation-runtime/attach/attach-stream-eligibility.js';
...
import { applyPermissionDecisionToLocalAssistantMessages, applyToolResultToLocalAssistantMessages, dismissPermissionEventMessage, hasActivePendingPermissionRequest, parseToolCallInputText, upsertPermissionEventMessage } from '../../../components/conversation-runtime/messages/support.js';
import type { AssistantTraceToolCall, ChatMessage, ChatMessagePart } from '../../../components/conversation-runtime/messages/support.js';
...
export interface SessionAttachDeps {
  ...
  readonly setRightTab: (value: "overview" | "plan" | "tools" | "bookmarks" | "terminals" | "skills" | "snapshots" | "history" | "viz" | "mcp" | "agent" | ((prev: "overview" | "plan" | "tools" | "bookmarks" | "terminals" | "skills" | "snapshots" | "history" | "viz" | "mcp" | "agent") => "overview" | "plan" | "tools" | "bookmarks" | "terminals" | "skills" | "snapshots" | "history" | "viz" | "mcp" | "agent")) => void;
