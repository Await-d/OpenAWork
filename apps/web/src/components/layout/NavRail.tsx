        ...
        >
            ...
            >
              <defs>
                ...
                <linearGradient id="navRailLogoStroke" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" style={{ stopColor: 'var(--accent-text)' }} stopOpacity="1" />
                  <stop
                    offset="100%"
                    style={{ stopColor: 'var(--accent-text)' }}
                    stopOpacity="0.85"
                  />
                </linearGradient>
              </defs>
          ...
          >
            <span
              style={{
                background:
                  'linear-gradient(90deg, var(--text), color-mix(in oklch, var(--text) 60%, var(--accent) 40%))',
