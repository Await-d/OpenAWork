...
.channel-card {
  border: 1px solid color-mix(in srgb, var(--border, var(--border-default)) 72%, transparent);
  border-radius: 12px;
  overflow: hidden;
  background: color-mix(in srgb, var(--surface, var(--bg-base, #080b12)) 97%, white 3%);
  box-shadow: none;
}
...
.channel-sidebar__hero,
.channel-panel__hero {
  border-bottom: 1px solid color-mix(in srgb, var(--border, var(--border-default)) 78%, transparent);
...
.channel-panel__title {
  ...
  font-size: 15px;
  line-height: 1.15;
  color: var(--text, var(--fg-default, #c8d1e0));
}

.channel-sidebar__description,
.channel-panel__description,
.channel-muted {
  color: var(--text-3, var(--fg-muted, #7b8a9e));
  font-size: 11px;
  line-height: 1.4;
}
...
.channel-path-entry input {
  ...
  border-radius: 8px;
  border: 1px solid color-mix(in srgb, var(--border, var(--border-default)) 80%, transparent);
  background: color-mix(in srgb, var(--bg, var(--bg-base, #080b12)) 92%, var(--fg-on-accent) 8%);
  color: var(--text, var(--fg-default, #c8d1e0));
  padding: 7px 9px;
  font-size: 11px;
  outline: none;
...
.channel-path-entry input:focus {
  border-color: color-mix(in srgb, var(--accent, var(--accent, var(--accent, #5cd4c0))) 68%, white 32%);
...
.channel-toggle input {
  accent-color: var(--accent, var(--accent, var(--accent, #5cd4c0)));
}
...
.channel-button--primary {
  background: var(--accent, var(--accent, var(--accent, #5cd4c0)));
