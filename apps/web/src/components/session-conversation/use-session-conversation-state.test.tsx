...
/**
 * useSessionConversationState v0.1 骨架测试
 *
 * 覆盖：
...
import { useSessionConversationState } from './use-session-conversation-state.js';
...
describe('useSessionConversationState — 空闲态', () => {
...
describe('useSessionConversationState — 加载快照', () => {
...
describe('useSessionConversationState — composer setter 暴露', () => {
...
describe('useSessionConversationState — 派生状态', () => {
...
describe('useSessionConversationState — submitInbound (v0.2)', () => {
