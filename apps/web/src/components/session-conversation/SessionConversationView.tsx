...
import { ChatMessageGroupList } from '../chat/chat-message-group-list.js';
import type { ChatRenderEntry, ChatRenderGroup } from '../chat/chat-message-group-list.js';
import { ChatRemoteStreamPlaceholder } from '../chat/chat-remote-stream-placeholder.js';
import { ChatSearchOverlay } from '../chat/chat-search-overlay.js';
import type { useChatSearch } from '../chat/chat-search-overlay.js';
import { ChatSessionSkeleton } from '../chat/chat-session-skeleton.js';
import { InlineQuestionPanel } from '../chat/InlineQuestionPanel.js';
import { UnifiedComposer } from '../chat/UnifiedComposer.js';
import type {
  UnifiedComposerFeatures,
  UnifiedComposerSubmitPayload,
} from '../chat/UnifiedComposer.js';
import { WelcomeScreen } from '../chat/ChatPageSections.js';
...
} from './runtime/chat-page-utils.js';
import type { ChatImageGenerationReferenceArtifact } from '../chat/ChatImageGenerationControls.js';
import HistoryEditDialog from './runtime/history-edit-dialog.js';
import RetryModeDialog from './runtime/retry-mode-dialog.js';
import { ChatScrollBottomButton } from './runtime/scroll-bottom-button.js';
import { ChatStreamErrorBar } from './runtime/stream-error-bar.js';
// ChatTodoFloatingPanel 现在由 ChatTopBar 内部挂载（顶部右侧），本组件不再渲染浮层；
// 仅保留与 todo 相关的最小 props（sessionTodos / rightOpen），用于消息列展示。
import { SessionRunStateBar } from './runtime/session-run-state-bar.js';
import type { SessionStateStatus, SessionTodoItem } from './runtime/session-runtime.js';
import type {
  ChatMessage,
  ComposerMenuState,
  ReasoningEffort,
...
import type { ImageEditReferenceArtifact } from './runtime/image-edit-reference-artifacts.js';
...
export function SessionConversationView(props: SessionConversationViewProps): React.ReactElement {
  const {
    sessionId,
    currentUserEmail,
    gatewayUrl,
