  ...
  return (
    <button
      ...
      style={{
        ...
        borderRadius: 5,
        border: 'none',
        background: open ? 'color-mix(in srgb, var(--aux) 18%, var(--surface))' : 'transparent',
        color: open ? 'var(--aux, var(--aux, #8b9cf5))' : 'var(--text-3)',
        boxShadow: open ? 'inset 0 0 0 1px color-mix(in srgb, var(--aux, var(--aux, #8b9cf5)) 50%, var(--border))' : 'none',
        fontSize: 11,
        fontWeight: 600,
