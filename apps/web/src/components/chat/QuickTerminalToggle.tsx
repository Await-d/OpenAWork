  ...
  return (
    <button
      ...
      style={{
        ...
        borderRadius: 5,
        border: 'none',
        background: open ? 'color-mix(in srgb, #3b82f6 18%, var(--surface))' : 'transparent',
        color: open ? '#3b82f6' : 'var(--text-3)',
        boxShadow: open ? 'inset 0 0 0 1px color-mix(in srgb, #3b82f6 50%, var(--border))' : 'none',
        fontSize: 11,
        fontWeight: 600,
