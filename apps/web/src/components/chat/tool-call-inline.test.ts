...
import { formatGroupItem } from './tool-call/grouped-tool-call-pill.js';
import {
  extractFilenameExtension,
  getToolCategory,
  tokenizeSummary,
} from './tool-call/shared/colorize-summary.js';
import { extractErrorSummary } from './tool-call/shared/extract-error-summary.js';
import { groupConsecutiveTools } from './tool-call/shared/group-consecutive-tools.js';
import { textContainsPath, tokenizePathsInText } from './tool-call/shared/tokenize-paths.js';
import {
