...
import { usePromptTemplateStore, type PromptTemplate } from '../../stores/prompt-templates.js';
      ...
      >
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <span style={{ fontSize: 11, color: 'var(--text-3)' }}>{templates.length} 个模板</span>
          </div>
          ...
          >
            <button
              ...
              style={{
                ...
                color: filterCategory === null ? 'white' : 'var(--text-2)',
                fontSize: 10,
                fontWeight: 500,
                cursor: 'pointer',
              }}
            ...
            {categories.map((cat) => (
              <button
                ...
                style={{
                  ...
                  color: filterCategory === cat ? 'white' : 'var(--text-2)',
                  fontSize: 10,
                  fontWeight: 500,
                  cursor: 'pointer',
                }}
