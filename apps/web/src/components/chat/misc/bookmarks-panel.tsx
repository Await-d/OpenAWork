...
import { useBookmarkStore, type MessageBookmark } from '../../../stores/chat/bookmarks.js';
        ...
        <button
          ...
          style={{
            ...
            background: !showAll
              ...
              : 'transparent',
            color: !showAll ? 'var(--accent)' : 'var(--fg-muted)',
            fontSize: 10,
            fontWeight: 500,
            cursor: 'pointer',
          }}
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 4 }}>
        ...
        <span style={{ fontSize: 10, color: 'var(--fg-muted)', flex: 1 }}>{timeLabel}</span>
